...
public class EX092003 {

	public static void main(String[] args) {
		// TODO 自動產生的方法 Stub
		Child chd = new Child();
		System.out.println(chd.age);
	//	chd.mark();
	//	chd.print();
		
		System.out.println(chd.whoclass);
		System.out.println(((Father)chd).whoclass);
		chd.myname(); //方法若在子類別可用則用, 若無則用父類別方法
		
		System.out.println(((Father)chd).age);
	}
